...
import {Badge, Button, Card, Descriptions, Divider, Form, Input, message, Table, TablePaginationConfig} from 'antd';
...
} from "@/services/yaapi-backend/interfaceInfoController";
          ...
          <Descriptions title={data.name} column={4} layout={'vertical'}>
            ...
            <Descriptions.Item label="响应参数说明" span={4}>
              <Table
                ...
                dataSource={data?.responseParamsRemark as any}
              />
            </Descriptions.Item>
